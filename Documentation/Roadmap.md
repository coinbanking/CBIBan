...
## Vision
CBIban is an open source library to help designers and developers design and prototype customized UI, interaction, navigation, transition and animation for App Store ready Apps in Interface Builder.
...
* **UIKit** - All `CBIban` UI elements are based on `UIKit`.
 	* **Dos**
...
* **iOS version** - Currently, `CBIban` supports iOS 8 and above.
    	* **Dos**
...
* **Swift** - Currently, `CBIban` supports Swift only.
	* **Dos**
...
You can find more details in https://github.com/coinbanking/CBIban/milestones
...
* Blur:
	...
	* <del>blurOpacity</del>
	* Motion Blur - https://github.com/coinbanking/CBIban/issues/65
...
* Checkbox:
	...
	* Animations for state changes - https://github.com/coinbanking/CBIban/issues/67
	* Default checked and unchecked icon (Using path to avoid image assets?) - https://github.com/coinbanking/CBIban/issues/68
	* Checked color - https://github.com/coinbanking/CBIban/issues/69
...
* Collection View and Collection View Cell - https://github.com/coinbanking/CBIban/issues/53
* Animatable Slider - https://github.com/coinbanking/CBIban/issues/70
* Material Design elements - and https://github.com/coinbanking/CBIban/issues/16 and  https://github.com/coinbanking/CBIban/issues/55
* <del>Flat colors</del>
* Motion effect, parallax effect - https://github.com/coinbanking/CBIban/issues/18
* Segmented Control - https://github.com/coinbanking/CBIban/issues/72
* Custom dynamic type (text style) - https://github.com/coinbanking/CBIban/issues/73
...
* Animations types:
	...
	* <del>MoveTo</del>
	* <del>MoveBy</del>
	* <del>scale</del> - https://github.com/coinbanking/CBIban/issues/121
	* Jump - https://github.com/coinbanking/CBIban/issues/75
...
* `AnimatablePresentationController`: [#198](https://github.com/coinbanking/CBIban/issues/198)
...
* Sketch plugin to export `CBIban` styles from Sketch, e.g. generating `Opacity=0.5; fillColor=#336699;` from Sketch and easily apply in Interface Builder.
