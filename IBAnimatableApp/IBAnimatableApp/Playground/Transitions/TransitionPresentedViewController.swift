...
private extension TransitionPresentedViewController {
  ...
  func prepareSegues() {
    ...
    var segueName = "CBIban.Present" + extractAnimationType(transitionAnimationType.stringValue.capitalized) + "Segue"
    ...
    segueName = "CBIban.Present" + extractAnimationType(transitionAnimationType.stringValue.capitalized) + "WithDismissInteractionSegue"
